...
public class TelaVestigioManchaSangue extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adicionar_vestigio_mancha_sangue);
    ...
    private void configuraBotaoGravar() {
        ...
        botaoGravar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TelaVestigioManchaSangue.this,TelaListaVestigios.class));
            }
        });
    ...
    private void configuraBotaoVoltar() {
        ...
        botaoVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(new Intent(TelaVestigioManchaSangue.this, MainActivity.class));
    ...
    private void configuraBotaoAdiciona() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelaVestigioManchaSangue.this,TelaAdicionarVestigio.class));
            }
        });
    }
}
