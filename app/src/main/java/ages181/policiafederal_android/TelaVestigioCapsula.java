...
public class TelaVestigioCapsula extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adicionar_vestigio_capsula);
    ...
    private void configuraBotaoGravar() {
        ...
        botaoGravar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TelaVestigioCapsula.this,TelaListaVestigios.class));
            }
        });
    ...
    private void configuraBotaoVoltar() {
        ...
        botaoVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(new Intent(TelaVestigioCapsula.this,MainActivity.class));
    ...
    private void configuraBotaoAdiciona() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelaVestigioCapsula.this,TelaAdicionarVestigio.class));
            }
        });
    }
}
